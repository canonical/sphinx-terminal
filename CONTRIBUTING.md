...
issues](https://github.com/canonical/sphinx-terminal/issues) first. If you have
fresh input, add your voice to the issue.

If the bug or feature doesn't have an issue, we invite you to [open
one](https://github.com/canonical/sphinx-terminal/issues/new/choose).
...
fork](https://github.com/canonical/sphinx-terminal/fork) of the repository on
GitHub.

Next, on your host system, clone your fork and sync it with the upstream repository:

```bash
git clone git@github.com:<username>/sphinx-terminal
cd sphinx-terminal
git remote add upstream git@github.com:canonical/sphinx-terminal
git fetch upstream
```
...
```bash
git clone https://github.com/<username>/sphinx-terminal
cd sphinx-terminal
git remote add upstream https://github.com/canonical/sphinx-terminal
git fetch upstream
```
...
The sphinx-terminal test suite includes both unit and integration tests. If you're not
...
Finally, [open a PR](https://github.com/canonical/sphinx-terminal/compare) for it on
